          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">Welcome back, {adminData.username}</p>
              </div>
            </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">{stats.totalResumes.toLocaleString()}</dd>
                    </dl>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <button 
                  onClick={() => window.location.href = '/admin/add-template'}
                ...
                <button className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                  <svg className="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <table className="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Created resume</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">jane.smith@example.com</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Updated profile</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">mike.wilson@example.com</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Downloaded template</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">8 minutes ago</td>
                      <td className="px-6 py-4 whitespace-nowrap">
